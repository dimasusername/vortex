...
Sister project [conduit](https://github.com/dimasusername/conduit) feeds Nasdaq market data into `vortex`. Together these two projects form an end-to-end market data → order book pipeline.
